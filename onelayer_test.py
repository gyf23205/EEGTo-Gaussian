...
X_test = data.load_unlabeled_data(['D:/pycharm/Projects/EEGToGaussian/features_per_class/test/feature_class4.npz'])
test_db = tf.data.Dataset.from_tensor_slices(X_test[0]).batch(1)
[w1, b1, w2, b2, w3, b3] = np.load('./net_weights4.npy', allow_pickle=True)
