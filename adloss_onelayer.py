...
X_train = data.load_unlabeled_data(['D:/pycharm/Projects/EEGToGaussian/features_per_class/train/feature_class4.npz'])
...
#     print(step)
#     print(x_train)
w1 = tf.Variable(tf.random.truncated_normal([4, 20], stddev=0.1, seed=10))
b1 = tf.Variable(tf.random.truncated_normal([20], stddev=0.1, seed=10))
w2 = tf.Variable(tf.random.truncated_normal([20, 1], stddev=0.1, seed=3))
...
np.save('net_weights4', np.array([w1.numpy(), b1.numpy(), w2.numpy(), b2.numpy()], dtype=object))
